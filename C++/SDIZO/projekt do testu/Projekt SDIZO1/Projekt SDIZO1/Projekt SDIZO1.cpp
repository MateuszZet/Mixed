...
void tablica_menu()
{
	...
	case 4:
		...
		int wartosc, result;
		cin >> wartosc;
		{ofstream out("tablica-szukanie.txt");
		for (int i = 0; i < 50; i++){
...
void tablica_menu_dodaj()
{
	...
	case 1:
		...
		cin >> numer;
		{ofstream out("tabdodawaniepocz.txt");
		for (int i = 0; i < 50; i++){
			performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
	...
	case 2:
		...
		cout << "Podaj wartosc" << endl;
		cin >> numer;
		{ofstream out("tabdodawanisrod.txt");
		for (int i = 0; i < 50; i++){
			performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
	...
	case 3:
		cout << "Podaj wartosc" << endl;
		cin >> numer;
		{ofstream out("tabdodawaniekoniec.txt");
		for (int i = 0; i < 50; i++){
			performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
...
void tablica_menu_usun()
{
	...
	switch (wybor){
	case 1:
	{ofstream out("tab_usun_pocz.txt");
	for (int i = 0; i < 50; i++){
		performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
...
void kopiec_menu()
{
	...
	case 4:
		...
		cout << "Podaj wartosc elementu do wyszukania" << endl;
		cin >> wartosc;
		{ofstream out("kopiec_szukaj.txt");
		for (int i = 0; i < 50; i++){
			performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
			kopiec.znajdz(wartosc);
			performanceCountEnd = endTimer(); //zapamiêtujemy koniec czasu
...
void lista_menu()
{
	...
	case 4:
		...
		int wartosc;
		cin >> wartosc;
		{ofstream out("lista_znajdz.txt");
		for (int i = 0; i < 50; i++){
			performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
			lista.znajdz(wartosc);
			performanceCountEnd = endTimer(); //zapamiêtujemy koniec czasu
...
void lista_menu_dodaj()
{
	...
	case 1:
		cout << "Podaj wartosc" << endl;
		cin >> wartosc;
		{ofstream out("list_dod_pocz.txt");
		for (int i = 0; i < 50; i++){
			performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
...
void lista_menu_usun()
{
	...
	switch (wybor){
	case 1:
	{ofstream out("list_usunpocz.txt");
	for (int i = 0; i < 50; i++){
		performanceCountStart = startTimer(); //zapamiêtujemy czas pocz¹tkowy
		lista.usun_zprzodu();
		performanceCountEnd = endTimer(); //zapamiêtujemy koniec czasu
